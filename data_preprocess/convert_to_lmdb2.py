...
def main():
    ...
    path_to_train_lmdb_dir = os.path.join('D:\\Project_repository\\CADC\\SVHNClassifier-PyTorch-master\\data1', 'train.lmdb')
    path_to_val_lmdb_dir = os.path.join('D:\\Project_repository\\CADC\\SVHNClassifier-PyTorch-master\\data1', 'val.lmdb')
    path_to_test_lmdb_dir = os.path.join('D:\\Project_repository\\CADC\\SVHNClassifier-PyTorch-master\\data1', 'test.lmdb')
    path_to_lmdb_meta_file = os.path.join('D:\\Project_repository\\CADC\\SVHNClassifier-PyTorch-master\\data1', 'lmdb_meta.json')
